...
#
# 版本号遵循上游的日期式版本，但 RPM 的 Version 不允许含连字符，所以 v26.9.23-1 拆成
...
%changelog
* Tue Sep 23 2026 Felix <noreply@example.com> - 26.9.23-1
- Key bindings: config-driven table + key-bindings page
- Daemon owns state and pushes changes to subscribed clients
